...
#import "JKChatHistoryViewController.h"
...
#import "JKChatHistoryTableViewCell.h"
#define VIEW_WIDTH self.view.frame.size.width

@interface JKChatHistoryViewController ()<UITableViewDataSource, UITableViewDelegate,NSFetchedResultsControllerDelegate,UISearchBarDelegate, UISearchDisplayDelegate>
...
@implementation JKChatHistoryViewController
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    if (![chatSession.topicId isEqualToString:@""]) {
        ...
        JKChatHistoryTableViewCell *cell = [[JKChatHistoryTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle
