...
+(id)sharedContext {
    ...
    dispatch_once(&onceToken, ^{
        ...
        // create model
        NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Joka"
                                                  withExtension:@"momd"];
        NSManagedObjectModel *model = [[NSManagedObjectModel alloc] initWithContentsOfURL:modelURL];
        
        // create coordinator
        NSURL *persistentStorestoreURLDoc = [[CoreDataUtil applicationDocumentsDirectory] URLByAppendingPathComponent:@"Joka"];
        NSError *error = nil;
